...
export default function AboutSection() {
  return (
    <div className="space-y-4 md:text-xl lg:text-2xl">
      ...
      <p>
        {
          "I'm a software engineer with about 4 years of experience in designing and developing applications using Microsoft Azure, C# (.NET Core) and React, currently I work with Coeo."
        }
      </p>
      <>
      ...
      <>
        ...
        <ul className="list-disc ml-8 md:ml-16">
          <li>
            <InlineLink label={"GuestLens.xyz 🚀"} url={"https://guestlens.xyz/"} />
          </li>
          <li>
            <InlineLink
